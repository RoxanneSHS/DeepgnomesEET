...
END
+ ~GlobalLT("Chapter","GLOBAL",3)~ + @69 /* ~I'm looking for an old friend, Imoen, who was arrested by the Cowled Wizards. Do you know where they might have taken her?~ */ EXTERN agaurora aurora14
+ ~GlobalLT("Chapter","GLOBAL",3)~ + @70 /* ~I am looking for a wizard, Irenicus, who was captured by the Cowled Wizards. Do you know where they might have taken him?~ */ EXTERN agaurora aurora15
...
@68 /* ~So, what brings you to Athkatla?~ */
END
+ ~GlobalLT("Chapter","GLOBAL",3)~ + @69 /* ~I'm looking for an old friend, Imoen, who was arrested by the Cowled Wizards. Do you know where they might have taken her?~ */ EXTERN agaurora auroraf14
+ ~GlobalLT("Chapter","GLOBAL",3)~ + @70 /* ~I am looking for a wizard, Irenicus, who was captured by the Cowled Wizards. Do you know where they might have taken him?~ */ EXTERN agaurora auroraf15
...
SetGlobal("ag_atimer2","GLOBAL",1)~
== EDWINJ_ @319 /* ~I should think that would be apparent even to someone of your obviously limited intelligence.~ */
...
== EDWINJ_ @321 /* ~I will not stand here and be insulted by a lowly *shopkeeper.* Bah.~ */
...
== EDWINJ_ @323 /* ~We train our slaves well.~ */
...
+ ~GlobalLT("chapter","GLOBAL",3)~ + @480 /* ~I have to save my friend. I don't have time for love!~ */ EXTERN agaurora banter_pc215
+ ~GlobalGT("chapter","GLOBAL",4)~ + @481 /* ~I am missing my soul and have to get it back from a madman. There's no time for love!~ */ EXTERN agaurora banter_pc215
...
== IMOEN2_ @524 /* ~You wouldn't happen to have any boots in pink, would you?~ */
== agaurora @525 /* ~Not at the moment, but I am sure I could have a pair dyed for you. What kind are you wanting?~ */
== IMOEN2_ @526 /* ~Something I can move about quietly in, you know, sneak up on people, and all that.~ */
...
SetGlobal("ag_atimer2","GLOBAL",1)~
== IMOEN2_ @528 /* ~Hey Aurora!~ */
== agaurora @529 /* ~Hello, Imoen!~ */
== IMOEN2_ @530 /* ~Just wondering... have you got those boots in for me yet?~ */
...
SetGlobal("ag_atimer2","GLOBAL",1)~
== MINSCJ_ @545 /* ~Boo is no mouse! Boo is a miniature giant space hamster!~ */
== agaurora @546 /* ~Ah... I see. Could you please get Boo off my counter before he makes a miniature giant mess?~ */
== MINSCJ_ @547 /* ~Boo would not make a mess of a friend's shoes! Boo does not make messes... Eh, well, he sometimes scatters cracker crumbs, but Minsc does too. Crumbs are hard to keep from falling.~ */
== agaurora @548 /* ~Are you sure he won't chew on the leather?~ */
== MINSCJ_ @549 /* ~Minsc is very sure!~ */
...
SetGlobal("ag_atimer2","GLOBAL",1)~
== MINSCJ_ @552 /* ~Boo says he is doing very well, though perhaps a little hungry.~ */
...
== MINSCJ_ @554 /* ~Oh, that is easy! We will eat them over where the little birds can have what falls.~ */ EXTERN agaurora now
...
== JAHEIJ @558 /* ~And *I* have never understood the need for the noise and filth of the cities.~ */
...
SetGlobal("ag_atimer2","GLOBAL",1)~
== VICONJ @561 /* ~The drow are practitioners of the erotic arts, yes. What is it you want from me, rivvil? Tips, perhaps?~ */
== agaurora @562 /* ~Well, girl-to-girl, and all.~ */
== VICONJ @563 /* ~The drow do *not* serve as teachers for the lesser races, unless they are slaves, and I doubt that such as you would last beyond the first night of breaking.~ */
== agaurora @564 /* ~You could just say no.~ */
= @565 /* ~And, it's not as though I am doing badly on my own.~ */
== VICONJ @566 /* ~Do not flatter yourself, frumpish one. I'm sure your pathetic exertions might please these surface scum, but your skills are nothing compared to mine.~ */
