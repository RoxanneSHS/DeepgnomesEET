This mod actually is an extract from a larger mod still in the making for EET, however well-known to old BGT-adventurers. So, consider this a teaser for the "Aurora's Shoes and Boots" mod. It restores part of the basic Aurora by Bookwyrme. 
...
This teaser just contains Tomthal and Karaea, Aurora's assistants, and a number of items that can be found randomly throughout the game. In addition, you can encounter some other svirfneblin who made it to the surface.
